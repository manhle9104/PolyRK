 ...
 * @author 4bacu
 */
public class BanHangTaiQuay1 extends javax.swing.JDialog {

    /**
     * Creates new form BanHangTaiQuay1
     */
    ...
    public BanHangTaiQuay1(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
...
//        jLabel2.setIcon(icon);
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(BanHangTaiQuay1.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                BanHangTaiQuay1 dialog = new BanHangTaiQuay1(new javax.swing.JFrame(), true);
